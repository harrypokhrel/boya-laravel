      ...
      <nav class="fixed top-0 left-0 right-0 flex items-center justify-between px-10 md:px-24 lg:px-36 xl:px-48 2xl:px-52 3xl:px-80 pt-8 z-10 navbar-transparent text-white" id="navbar">
        ...
        <ul class="flex items-center space-x-4">
          ...
          @guest
            @if (Route::has('login'))
              <li class="nav-item">
                  <a class="nav-link" href="" onclick="window.location='{{ route("login") }}'">{{ __('Login') }}</a>
              </li>
            @endif
            @else
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle welcome__username" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
